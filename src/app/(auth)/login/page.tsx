...
export default function LoginPage() {
  ...
  async function handleVerify2FA() {
    ...
    try {
      ...
      if (result?.error) {
        addToast(result.error === 'CredentialsSignin' ? 'Invalid verification code' : result.error, 'error');
      } else {
        router.push(callbackUrl);
        router.refresh();
      }
          ...
          <>
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-sm text-text-tertiary hover:text-text-secondary transition-colors mx-auto"
              >
                ...
                <button
                  ...
                  onClick={() => {
                    if (savedCredentials) {
                      setNeeds2FA(false);
                      setTwoFactorCode('');
                      // Re-submit login to resend OTP
                      onSubmit(savedCredentials as LoginInput);
                    }
                  }}
