...
export const CHALLENGE_PASSING_PLANS: ServicePlan[] = [
  {
    ...
    price: 299,
    description: 'Perfect for beginners looking to get their first funded account.',
    features: [
      '$25K – $50K challenge accounts',
      'Professional trader assigned',
      'Phase 1 & Phase 2 passing',
      'Email progress updates',
      'Standard support',
      '7–14 day completion',
    ],
    accountSizes: ['$25,000', '$50,000'],
  },
  {
    id: 'cp-professional',
    name: 'Professional',
    ...
    price: 599,
    originalPrice: 799,
    description: 'Our most popular plan for serious traders seeking larger accounts.',
    features: [
  ...
  },
  {
    ...
    price: 999,
    originalPrice: 1299,
    description: 'Premium service with guaranteed results for maximum account sizes.',
    features: [
      '$200K+ challenge accounts',
      'Elite trader assigned',
      'All phases included',
      'Real-time progress dashboard',
      'VIP 24/7 support',
      'Priority fast-track completion',
      'Detailed trade analytics',
      'Guaranteed pass or full refund',
    ],
    accountSizes: ['$200,000', '$300,000', '$400,000'],
...
export const ACCOUNT_MANAGEMENT_PLANS: ServicePlan[] = [
  {
    ...
    price: 499,
    description: 'Hands-off account management with consistent returns.',
    features: [
      'Up to $50K accounts',
  ...
  },
  {
    ...
    serviceType: ServiceType.ACCOUNT_MANAGEMENT,
    price: 799,
    description: 'Active management with optimized returns and priority support.',
    features: [
      'Up to $200K accounts',
  ...
  },
  {
    ...
    serviceType: ServiceType.ACCOUNT_MANAGEMENT,
    price: 1299,
    description: 'Premium management with aggressive growth strategies.',
    features: [
      '$200K+ accounts',
