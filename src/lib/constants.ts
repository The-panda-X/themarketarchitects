...
export const PROP_FIRMS: PropFirm[] = [
  ...
  { id: 'fundednext', name: 'FundedNext', phases: 2, accountSizes: ['$6,000', '$25,000', '$50,000', '$100,000', '$200,000'] },
  { id: 'thefundedtrader', name: 'The Funded Trader', phases: 2, accountSizes: ['$5,000', '$10,000', '$25,000', '$50,000', '$100,000', '$200,000'] },
  { id: 'e8markets', name: 'E8 Markets', phases: 2, accountSizes: ['$5,000', '$10,000', '$25,000', '$50,000', '$100,000', '$200,000', '$250,000'] },
  { id: 'fundingpips', name: 'Funding Pips', phases: 2, accountSizes: ['$5,000', '$10,000', '$25,000', '$50,000', '$100,000', '$200,000'] },
  { id: 'alphacapital', name: 'Alpha Capital', phases: 2, accountSizes: ['$5,000', '$10,000', '$25,000', '$50,000', '$100,000', '$200,000'] },
  { id: 'apextrader', name: 'Apex Trader Funding', phases: 1, accountSizes: ['$25,000', '$50,000', '$100,000', '$150,000'] },
  { id: 'other', name: 'Other', phases: 2, accountSizes: ['$5,000', '$10,000', '$25,000', '$50,000', '$100,000', '$200,000', '$300,000', '$400,000', 'Custom'] },
];
...
export const HOMEPAGE_FAQ: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'We support all major prop firms including FTMO, FundedNext, The Funded Trader, E8 Markets, Funding Pips, Alpha Capital, Apex Trader Funding, and many more. If your firm is not listed, select "Other" during checkout and contact us — we can likely accommodate it.',
  },
  {
